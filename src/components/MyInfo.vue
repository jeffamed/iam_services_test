<template>
  ...
  <span v-show="alert" class="bg-green-100 border border-green-300 block font-bold mx-auto py-1 rounded text-green-600 w-11/12">Actualizado Exitosamente</span>
</template>
